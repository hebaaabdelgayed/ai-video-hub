...
const seo = {
  ...
  faq: [
    ['هل Codex مفيد لغير المبرمجين؟', 'نعم. رغم أن Codex معروف في البرمجة، يوضح الفيديو أنه يمكن استخدامه أيضا في تنظيم الملفات، تجهيز الجداول، إدارة المهام، والمساعدة في أعمال إنتاجية يومية.'],
    ['ما أهم فكرة في هذا الشرح؟', 'الفكرة الأساسية أن Codex يمكن التعامل معه كوكيل ذكاء اصطناعي ينفذ خطوات عملية داخل مشروع أو مساحة عمل، وليس مجرد صندوق دردشة يجيب على الأسئلة.'],
    ['هل يمكن الاعتماد على Codex بدون مراجعة؟', 'لا. الأفضل استخدامه كمساعد قوي مع مراجعة النتائج، خصوصا في الملفات المهمة أو المهام التي قد تؤثر على بياناتك أو عملك.']
  ]
};
...
if (!file) throw new Error(`Could not find generated video page for ${targetVideoId}`);
...
if (!html.includes(`data-seo-pilot="${targetVideoId}"`)) {
  ...
  if (!html.includes(`data-seo-pilot="${targetVideoId}"`)) {
    throw new Error('SEO panel insertion failed.');
  }
